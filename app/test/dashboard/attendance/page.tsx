      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm flex items-center gap-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Courses at Risk</p>
          </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-50">
              ...
              <th className="text-left px-6 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wide">Attended / Total</th>
              <th className="text-left px-6 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wide w-48">Progress</th>
              <th className="text-left px-6 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wide">Percentage</th>
              ...
              return (
                <tr key={a.code} className="border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <p className="text-xs text-indigo-500 font-mono mt-0.5">{a.code}</p>
                  </td>
