    ...
    <aside className="w-60 shrink-0 bg-white border-r border-gray-100 flex flex-col min-h-screen">
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-gray-600 truncate">ID: S2024001 · Year 2</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
        >
          <LogOut size={16} />
          Log out
        </button>
